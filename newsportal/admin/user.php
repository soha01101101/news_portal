...
{
$id=intval($_GET['id']);
$query=mysqli_query($con,"update tbluser set Is_Active=0 where id='$id'");
if($query)
{
$msg="User deleted ";
}
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Subscribers</title>
...
<?php
$query=mysqli_query($con,"SELECT id, username, phonenumber, email, timestamp FROM tbluser ");
