...
$sql=mysqli_query($con,"SELECT password FROM  tbluser where username='$id' || email='id'");
...
if (password_verify($password, $dbpassword)) {
 ...
 $con=mysqli_query($con,"update tbluser set password ='$newhashedpass', updationDate='$currentTime' where username='$id'");
